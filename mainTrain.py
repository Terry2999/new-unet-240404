...
plt.title("Unet-loss")
plt.savefig(f"plot/{testID}/Unet-loss_{testID}.png")
plt.close()
# p1.show()
...
plt.savefig(f"plot/{testID}/UnetP-loss_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/UnetPP-loss_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/MyUnet-loss_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/Unet-vs-UnetP-vs-UnetPP-vs-M-loss_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/Unet-vs-UnetP-vs-UnetPP-vs-M-acc_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/Unet-vs-UnetP-vs-UnetPP-vs-M-dice_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/Unet-vs-UnetP-vs-UnetPP-vs-M-iou_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/Unet-vs-M-iou_{testID}.png")
plt.close()
# plt.show()
...
plt.savefig(f"plot/{testID}/Unet-vs-M-dice_{testID}.png")
plt.close()
# plt.show()